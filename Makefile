...
rau_chat: lib
	g++ -std=c++11 Examples/RAU_Chat_Server.cpp bin/libEasyNetwork.a -o bin/RAU_Chat_Server.exe $(CPPFlags)
	g++ -std=c++11 Examples/RAU_Chat_Client.cpp bin/libEasyNetwork.a -o bin/RAU_Chat_Client.exe $(CPPFlags)

file_sender: lib 
	g++ -std=c++11 Examples/TCP_FileSender_Server.cpp bin/libEasyNetwork.a -o bin/TCP_FileSender_Server.exe $(CPPFlags)
	g++ -std=c++11 Examples/TCP_FileSender_Client.cpp bin/libEasyNetwork.a -o bin/TCP_FileSender_Client.exe $(CPPFlags)

tcp_chat: lib
	g++ -std=c++11 Examples/TCP_Chat_Server.cpp bin/libEasyNetwork.a -o bin/TCP_Chat_Server.exe $(CPPFlags)
	g++ -std=c++11 Examples/TCP_Chat_Client.cpp bin/libEasyNetwork.a -o bin/TCP_Chat_Client.exe $(CPPFlags)

udp_chat: lib
	g++ -std=c++11 Examples/UDP_Chat_Server.cpp bin/libEasyNetwork.a -o bin/UDP_Chat_Server.exe $(CPPFlags)
	g++ -std=c++11 Examples/UDP_Chat_Client.cpp bin/libEasyNetwork.a -o bin/UDP_Chat_Client.exe $(CPPFlags)
